...
namespace Bitbucket.Net.Common.Mcp
{
    ...
    public static class DiffStreamingExtensions
    {
        ...
        private static Segment TruncateSegment(Segment original, int maxLines)
        {
            ...
            {
                Type = original.Type,
                Lines = original.Lines.Take(linesToTake).ToList(),
    ...
    public sealed class DiffStreamResult
    {
        ...
        internal static DiffStreamResult CreateTruncated(int totalLines, int totalFiles, string reason)
            => new(null, totalLines, totalFiles, isPartial: false, isTruncated: true, truncationReason: reason);
    }
    ...
    /// </summary>
    public sealed class DiffPaginatedResult
    {
        ...
        public DiffPaginatedResult(List<Diff> diffs, int totalLines, int totalFiles, bool wasTruncated, string? truncationReason)
        {
            _diffs = diffs;
            TotalLines = totalLines;
            TotalFiles = totalFiles;
