...
{
    public class DefaultReviewersExtendedMockTests : IClassFixture<BitbucketMockFixture>
    {
        private readonly BitbucketMockFixture _fixture;

        public DefaultReviewersExtendedMockTests(BitbucketMockFixture fixture)
        {
            _fixture = fixture;
        }
